...
# char_image = Image.open('gorkha_real_data.jpg')

# # draw the text
# font = ImageFont.truetype('fonts/inkjet/inkjet-regular.ttf', 20)
# # draw_rotated_text(char_image, 10, (100, 90), 'Chhabi Lal Tamang', (0, 10, 0), font=font)
